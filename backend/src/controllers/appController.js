...
function buildAppData(body) {
  ...
  return {
    ...
    downloads: normalizeDownloadCountText(body.downloads, '0'),
...
function patchAppData(current, body) {
  ...
  return {
    ...
    downloads: body.downloads !== undefined ? normalizeDownloadCountText(body.downloads, current.downloads) : normalizeDownloadCountText(current.downloads, '0'),
